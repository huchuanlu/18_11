function [W,imageEdges,ephase] = ICgraph(I,edge_im,edges,sp_ind_middle)
...
dataW.sampleRadius=20;     % Ô­Ê¼ÉèÖÃ
dataW.sample_rate=0.1;
% dataW.sampleRadius=30;
% dataW.sample_rate=0.5;
...
W = computeW(1,I,dataW,edgemap.emag,edgemap.ephase,edges,sp_ind_middle);
%W=W2;
